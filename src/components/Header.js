...
function Header(props) {
  ...
  return (
    <header className="d-flex justify-between align-center">
      <Link to={"/"}>
        <div className="d-flex align-center">
          <img
            ...
            alt="Logo"
          />
          {/* <img className="mr-15" width={40} height={40} src="public/img/header/logo.png" alt="" /> */}
          <div>
      ...
      <ul className="header__list d-flex align-center">
        <li className="header__item cu-p" onClick={props.onClickCart}>
          <svg
            className=""
            width="20"
            height="20"
        ...
        <Link to={"/favorites"}>
          <li className="header__item cu-p" >
